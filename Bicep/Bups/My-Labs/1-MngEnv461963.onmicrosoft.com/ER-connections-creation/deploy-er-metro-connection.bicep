...
param gatewayName string = 'ER-GateWay-southafricanorth-Standard'

@description('Resource group containing the existing ExpressRoute gateway.')
param gatewayResourceGroupName string = 'southafricanorth-region'

@description('Name of the ExpressRoute connection to create.')
param connectionName string = 'ER-Metro-Conn-to-ER-GateWay-southafricanorth-Standard'
