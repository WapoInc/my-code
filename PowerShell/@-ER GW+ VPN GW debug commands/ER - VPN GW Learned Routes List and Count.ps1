...
Connect-AzAccount
Get-AzSubscription
Select-AzSubscription -SubscriptionName "SITA Landing Zone"
...
==================================================================================================
$ER_Circuit_ER_LTSA_SA_North = "ER-LIT-SA-North"
$RG = "ER-LTSA-RG"
...
==================================================================================================
Get-AzExpressRouteCircuit -ResourceGroupName $RG -Name $ER_Circuit
