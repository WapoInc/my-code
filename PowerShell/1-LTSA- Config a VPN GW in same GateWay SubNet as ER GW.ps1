...
$GWName = "LTSA-VPN-GateWay-SA-North"
$GWIPName = "LTSA-VPN-GateWay-SA-North-Pub-IP"
$GWIPconfName = "gwipconf"
$VNetName = "ER-LTSA-RG-vnet"
...
$pip2 = New-AzPublicIpAddress -Name $GWIPName  -ResourceGroupName $RG -Location $Location -AllocationMethod Dynamic
...
$ipconf2 = New-AzVirtualNetworkGatewayIpConfig -Name $GWIPconfName -Subnet $subnet -PublicIpAddress $pip2
...
New-AzVirtualNetworkGateway -Name $GWName -ResourceGroupName $RG -Location $Location -IpConfigurations $ipconf $ipconf2 -GatewayType Vpn  -VpnType RouteBased -GatewaySku VpnGw1 -EnableActiveActiveFeature
#-------------------------------------------------------------------------------------------------------------------------------------
