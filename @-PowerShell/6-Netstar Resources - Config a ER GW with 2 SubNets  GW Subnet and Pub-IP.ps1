...
$GWName = "Netstar-ER-GW-ZA-North"
$GWIPName = "Netstar-ER-GW-ZA-North-Pub-IP"
$GWIPconfName = "gwipconf"
$VNetName = "Netstar-ZA-North-VN"
...
#-------------------------------------------------------------------------------------------------------------------------------------
# Create the configuration for your gateway. The gateway configuration defines the subnet and the public IP address to use. 
# In this step, you are specifying the configuration that will be used when you create the gateway. 
# This step does not actually create the gateway object. Use the sample below to create your gateway configuration.
$ipconf = New-AzVirtualNetworkGatewayIpConfig -Name $GWIPconfName -Subnet $subnet -PublicIpAddress $pip

#-------------------------------------------------------------------------------------------------------------------------------------
# Create the gateway. In this step, the -GatewayType is especially important. 
# You must use the value ExpressRoute. After running these cmdlets, the gateway can take 45 minutes or more to create.
