...
$GWName = "ER-GW-Az-Stratus-SA-North"
$GWIPName = "ER-GW-Az-Stratus-SA-North-Pub-IP"
...
# Add-AzVirtualNetworkSubnetConfig -Name SubNet-1 -VirtualNetwork $vnet -AddressPrefix 10.11.1.0/24
# Add-AzVirtualNetworkSubnetConfig -Name SubNet-2 -VirtualNetwork $vnet -AddressPrefix 10.11.2.0/24
#-------------------------------------------------------------------------------------------------------------------------------------
