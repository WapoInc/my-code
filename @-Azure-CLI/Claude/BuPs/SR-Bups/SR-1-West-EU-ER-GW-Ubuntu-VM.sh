...
LOCATION="westeurope"
VNET_NAME="west-eu-vnet-azure-hub"
...
EXPRESSROUTE_GATEWAY_NAME="west-eu-ergw-azure-hub"
EXPRESSROUTE_GATEWAY_PIP_NAME="west-eu-pip-ergw-hub"

# VM Configuration
VM_NAME="west-eu-ubuntu2204-vm"
