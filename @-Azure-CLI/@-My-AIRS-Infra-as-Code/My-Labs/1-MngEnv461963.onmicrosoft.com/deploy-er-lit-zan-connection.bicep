...
param connectionName string = 'ER-LIT-ZAN-Conn-to-ER-GateWay-SA-North-Standard'

@description('Resource ID of the existing ExpressRoute circuit.')
param circuitResourceId string = '/subscriptions/0cfd0d2a-2b38-4c93-ba14-cf79185bc683/resourceGroups/ER-LTSA-rg/providers/Microsoft.Network/expressRouteCircuits/ER-LIT-ZAN'
