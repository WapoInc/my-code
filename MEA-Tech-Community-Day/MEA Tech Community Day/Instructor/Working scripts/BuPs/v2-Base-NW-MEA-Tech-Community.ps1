...
Write-Host ""
Write-Host "Standard SKU Features:" -ForegroundColor Cyan
Write-Host "  ✓ Native client support (RDP/SSH via native clients)" -ForegroundColor Green
Write-Host "  ✓ IP-based connection" -ForegroundColor Green
Write-Host "  ✓ Shareable link" -ForegroundColor Green
Write-Host "  ✓ Session recording" -ForegroundColor Green
Write-Host "  ✓ Kerberos authentication" -ForegroundColor Green
...
Write-Host "  2. Use native RDP/SSH clients with Bastion Standard SKU" -ForegroundColor White
Write-Host "  3. Test connectivity from 192.168.1.0/24 to 10.70.1.0/24" -ForegroundColor White
Write-Host "  4. Test connectivity from 192.168.4.0/24 to 10.70.1.0/24" -ForegroundColor White
Write-Host "  5. Test VPN connectivity between sites" -ForegroundColor White
Write-Host "  6. Verify VM connectivity across VNets" -ForegroundColor White
Write-Host "  7. Monitor Azure Firewall metrics via Azure Portal" -ForegroundColor White
Write-Host "  8. Explore Bastion Standard features (IP-based connection, session recording)" -ForegroundColor White
Write-Host "==========================================" -ForegroundColor Cyan