...
resource virtualNetworks_10_222_name_SubNet_3 'Microsoft.Network/virtualNetworks/subnets@2020-08-01' = {
  name: '${virtualNetworks_10_222_name_resource.name}/SubNet-3'
  properties: {
    addressPrefix: '10.222.0.192/26'
    serviceEndpoints: []
    delegations: []
