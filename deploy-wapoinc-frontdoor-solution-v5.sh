...
#
# v5 — Added: per-resource deployment prompts, start/end timestamps,
...
echo "╔══════════════════════════════════════════════════════════════════════════╗"
echo "║        WapoInc Front Door Solution — Deployment Script v5              ║"
echo "╠══════════════════════════════════════════════════════════════════════════╣"
...
if [ "$FD_READY" = true ]; then
  ...
  echo "║                   Re-check: curl -I https://$AFD_HOSTNAME/"
fi
echo "╠══════════════════════════════════════════════════════════════════════════╣"
echo "║  Start Date/Time : $SCRIPT_START_TIME                                    ║"
