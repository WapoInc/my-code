...
$LogAnalyticsWorkspaceName = "azfw-diags"
...
Write-Host "  • Retention:     30 days" -ForegroundColor White
...
# ============================================================================
Write-Host "=============================================================================" -ForegroundColor Yellow
Write-Host "Configuring Azure Firewall Diagnostic Settings..." -ForegroundColor Yellow
Write-Host "=============================================================================" -ForegroundColor Yellow

# Define all log categories for Azure Firewall
$logCategories = @(
    ...
    "AzureFirewallDnsQuery",
    "AzureFirewallFqdnResolveFailure",
    "AzureFirewallFatFlow",
...
# Create log setting objects for each category
$logs = @()
...
# Create metric setting object
$metric = New-AzDiagnosticSettingMetricSettingsObject `
  -Enabled $true `
  -Category AllMetrics

# Create the diagnostic setting with all logs and metrics
...
Write-Host "=============================================================================" -ForegroundColor Green
Write-Host ""
Write-Host "Diagnostic Settings Details:" -ForegroundColor Cyan
Write-Host "  • Name:                azfw-diagnostics" -ForegroundColor White
Write-Host "  • Log Analytics:       $LogAnalyticsWorkspaceName" -ForegroundColor White
Write-Host "  • Destination Type:    Resource Specific (Dedicated)" -ForegroundColor White
Write-Host "  • Region:              $Location" -ForegroundColor White
Write-Host ""
Write-Host "Enabled Log Categories:" -ForegroundColor Yellow
Write-Host "  ✓ Azure Firewall Network Rule" -ForegroundColor Green
Write-Host "  ✓ Azure Firewall Application Rule" -ForegroundColor Green
Write-Host "  ✓ Azure Firewall Nat Rule" -ForegroundColor Green
Write-Host "  ✓ Azure Firewall Threat Intelligence" -ForegroundColor Green
Write-Host "  ✓ Azure Firewall IDPS Signature" -ForegroundColor Green
Write-Host "  ✓ Azure Firewall DNS Query" -ForegroundColor Green
Write-Host "  ✓ Azure Firewall FQDN Resolution Failure" -ForegroundColor Green
Write-Host "  ✓ Azure Firewall Fat Flow Log" -ForegroundColor Green
Write-Host "  ✓ Azure Firewall Flow Trace Log" -ForegroundColor Green
Write-Host "  ✓ Azure Firewall Network Rule Aggregation (Policy Analytics)" -ForegroundColor Green
Write-Host "  ✓ Azure Firewall Application Rule Aggregation (Policy Analytics)" -ForegroundColor Green
Write-Host "  ✓ Azure Firewall Nat Rule Aggregation (Policy Analytics)" -ForegroundColor Green
Write-Host ""
Write-Host "Enabled Metrics:" -ForegroundColor Yellow
Write-Host "  ✓ All Metrics" -ForegroundColor Green
Write-Host "=============================================================================" -ForegroundColor Green
Write-Host ""
...
Write-Host "  • Name: $LogAnalyticsWorkspaceName" -ForegroundColor White
...
Write-Host "  • Private IP: $FirewallPrivateIp" -ForegroundColor White
Write-Host "  • Public IP: $FirewallPublicIp" -ForegroundColor White
Write-Host "  • Diagnostics: Enabled (Resource Specific - 12 log categories)" -ForegroundColor White
Write-Host "  • Log Analytics: $LogAnalyticsWorkspaceName" -ForegroundColor White
...
Write-Host "  2. Query Azure Firewall logs in workspace: $LogAnalyticsWorkspaceName" -ForegroundColor White
Write-Host "  3. Run KQL queries to monitor network, application, and NAT rule hits" -ForegroundColor White
Write-Host "  4. Test VPN connectivity between sites" -ForegroundColor White
Write-Host "  5. Verify VM connectivity across VNets" -ForegroundColor White
Write-Host "==========================================" -ForegroundColor Cyan